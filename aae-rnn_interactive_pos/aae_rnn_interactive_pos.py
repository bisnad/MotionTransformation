...
motion_model.config["weights_path"] = ["../aae-rnn/results_MMPose2D_HannahMartin/weights/encoder_weights_epoch_450", "../aae-rnn/results_MMPose2D_HannahMartin/weights/decoder_weights_epoch_450"]
#motion_model.config["weights_path"] = ["../aae-rnn/results_MMPose3D_HannahMartin/weights/encoder_weights_epoch_200", "../aae-rnn/results_MMPose3D_HannahMartin/weights/decoder_weights_epoch_200"]
