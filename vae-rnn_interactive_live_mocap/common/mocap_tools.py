    ...
    def euler_to_quat(self, rotations_euler, rot_sequence):
        ...
        for fI in range(frame_count):
            ...
            for jI in range(joint_count):
                ...
                euler_1 = rotations_euler[fI, jI, 0]/180.0 * math.pi;
                euler_2 = rotations_euler[fI, jI, 1]/180.0 * math.pi;
                euler_3 = rotations_euler[fI, jI, 2]/180.0 * math.pi;
                # euler_x = rotations_euler[fI, jI, rot_sequence[0]]/180.0 * math.pi;
                # euler_y = rotations_euler[fI, jI, rot_sequence[1]]/180.0 * math.pi;
                # euler_z = rotations_euler[fI, jI, rot_sequence[2]]/180.0 * math.pi;
