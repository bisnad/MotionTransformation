...
class CausalMotionVAE(nn.Module):
    def __init__(
        ...
        self.conv_channel_counts = list(conv_channel_counts)
        ...
        self.encoder = MotionEncoder(
            ...
            channel_counts=self.conv_channel_counts,
            kernel_sizes=self.conv_kernel_sizes,
            strides=self.conv_strides,
            dilations=self.conv_dilations,
        )

        rev_channels = list(reversed(self.conv_channel_counts))
        rev_kernels = list(reversed(self.conv_kernel_sizes))
        rev_strides = list(reversed(self.conv_strides))
        rev_dilations = list(reversed(self.conv_dilations))
